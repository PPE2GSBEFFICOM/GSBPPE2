...
*/
	public function getLesVisiteurs(){
		...
		where visiteur.type='visiteur' and fichefrais.idEtat='CR' 
 ...
 */
	...
	public function ajouterVisiteur($nom, $prenom, $login, $mdp, $type){
		$req = "insert into visiteur
		values($nom, $prenom, $login, $mdp, $type)";
			try	{ PdoGsb::$monPdo->exec($req);}
