				...
				<div class="box">
					<div class="content-wrap">
						...
						<!-- <div class="already">
							...
							<form method="post" class="registration" action="index.php?uc=connexion&action=creerCompte">		                
								<input class="btn btn-theme btn-info" type="submit" value="Créer un compte">
							</form>
						</div> -->
					</div>							
				</div>
